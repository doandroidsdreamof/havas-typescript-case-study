...
const PageLayout: React.FunctionComponent<LayoutProps> = (props: LayoutProps) => {
  return (
    <>
      ...
      <div className='h-screen  w-full dark:bg-gray-900 flex flex-col gap-20 '>
        <div className=''>{props.TopNavBar}</div>
        <div className=' px-9 md:px-2 sm:ml-64  flex flex-col-reverse gap-5 md:flex-row-reverse md:items-center justify-between '>
